  ...
  @yield('content')
    ...
    <footer class="site-footer">
      <div class="container">
        ...
        @if(\App\Models\Setting::where('key', 'discord_invite_url')->value('value'))
        <a href="{{ \App\Models\Setting::where('key', 'discord_invite_url')->value('value') }}" target="_blank" style="color:#9aa6b2; text-decoration:none; vertical-align:middle; margin-left:10px; display:inline-flex; align-items:center;" title="Discord">
          <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 24 24">
